...
const Notification = () => {
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-purple-50 via-white to-blue-50 flex flex-col">
      <header className="flex items-center gap-3 px-8 py-8 border-b bg-white shadow-sm">
        <Bell size={36} className="text-purple-600 drop-shadow" />
      ...
      <main className="flex-1 flex justify-center items-center">
        <div className="w-full max-w-4xl">
          <div className="bg-white rounded-2xl shadow-xl border p-0 sm:p-6">
            {notifications.length === 0 ? (
              ...
              <ul className="divide-y">
                {notifications.map((notif) => (
                  <li
                    key={notif.id}
                    className={`flex items-center gap-4 py-6 px-4 sm:px-8 transition-all rounded-xl ${
                      notif.read
